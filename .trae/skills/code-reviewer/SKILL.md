...
name: code-reviewer
description: >-
  Revisão de código, boas práticas e análise de PRs Quando usar: review, code review, pr, pull request, revisar, criticar.
---

# code-reviewer

> Revisão de código, boas práticas e análise de PRs
