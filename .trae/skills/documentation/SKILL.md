...
name: documentation
description: >-
  Escrita técnica, manutenção de documentação, changelogs e guias de usuário Quando usar: documentação, docs, readme, changelog, tutorial, guia, escrever, explicar.
---

# documentation

> Escrita técnica, manutenção de documentação, changelogs e guias de usuário
