...
name: git
description: >-
  Versionamento, convenções de commit (Conventional Commits), estratégias de branching, merges e resolução de conflitos Quando usar: git, commit, merge, rebase, branch, conflito.
---

# git

> Versionamento, convenções de commit (Conventional Commits), estratégias de branching, merges e resolução de conflitos
