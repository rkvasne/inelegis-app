...
As entradas anteriores a 02/12/2025 foram movidas para [`history/CHANGELOG-DOCS-ARCHIVE.md`](history/CHANGELOG-DOCS-ARCHIVE.md) para manter este arquivo enxuto.
